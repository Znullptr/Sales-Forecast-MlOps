...
def VARModel(data_url,version,df,train_split,test_split):

    # disable autologging
    mlflow.sklearn.autolog(disable=True)
    with mlflow.start_run(run_name='VAR'):
        ...
        mse = mean_squared_error(test_split, forecast_df)
